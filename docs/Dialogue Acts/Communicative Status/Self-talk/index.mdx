...
**Used when:** used when the source argument does not seem to be intended for the listener to respond to, or talking to one-self. It can be used to capture the "thinking-out-loud" actions.
